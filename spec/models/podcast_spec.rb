...
RSpec.describe Podcast, type: :model do
  describe "#syncronize" do
    ...
    before(:each) do
      stub_request(:get, /www.hellointernet.fm/).
        to_return(body: File.new('spec/data/hi_rss_feed.xml'), status: 200)
    end
  ...
  describe ".sync" do
    it "calls syncronize on each existing podcast" do
      ...
      create :podcast, rss_link: "http://one"
      create :podcast, rss_link: "http://two"
      create :podcast, rss_link: "http://three"
